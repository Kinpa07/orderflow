...
def test_tenant_create_email_validation_without_at_symbol():
...
def test_tenant_create_email_validation_without_company_name():
    with pytest.raises(ValidationError) as exc_info:
        TenantCreate(
            company_name="Test Company",
            contact_name="John Doe",
...
def test_tenant_create_valid_email():
    tenant = TenantCreate(
        company_name="Test Company",
        contact_name="John Doe",
...
def test_invalid_config():
    with pytest.raises(ValidationError) as exc_info:
        TenantConfig(maximum_price="not_a_float")